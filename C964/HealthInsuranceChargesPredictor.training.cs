...
namespace C964
{
    public partial class HealthInsuranceChargesPredictor
    {
        public const string RetrainFilePath =  @"C:\Users\casal\Downloads\Insurance_Dataset_Cleaned - Copy.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(new []{new InputOutputColumnPair(@"sex", @"sex"),new InputOutputColumnPair(@"smoker", @"smoker"),new InputOutputColumnPair(@"region", @"region")}, outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    ...
                                    .Append(mlContext.Regression.Trainers.FastForest(new FastForestRegressionTrainer.Options(){NumberOfTrees=4,NumberOfLeaves=8,FeatureFraction=0.9427458F,LabelColumnName=@"charges",FeatureColumnName=@"Features"}));
